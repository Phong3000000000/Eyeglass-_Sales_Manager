...
namespace DEAN_SQL
{
    public partial class WorkWithData : Form
    {
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            string getColumnNamesQuery = $"EXEC P_GET_COLUMN_NAME '{selectedTable}'";
            ...
            string bcpCommand = $"bcp {selectedTable} out \"{tempFilePath}\" -c -t, -C 65001 -U sa -P sa -S LAPTOP-H6IDD6F8\\SQLEXPRESS -d DEAN5";
